// aqui esta somente algumas notas que fiz sobre funções
// existem varias funções preprogramadas pelo JS que ajudam os dev, uma delas é a de math e aqui algumas delas.
/*
